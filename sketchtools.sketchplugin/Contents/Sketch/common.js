...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var rssUrl = 'https://cdn.rawgit.com/JayLyu/baikong/0de786cf/tmall.xml';
  Library.getRemoteLibraryWithRSS(rssUrl, function (err, library) {
    if (err) {
      UI.message("Fail");
    }

    UI.message("Succeed"); // UI.alert('my title', 'Hello World!')

    console.log(rssUrl); // console.log(Library)
